...
(async()=>{try{
  ...
  await ready();
  let h=await req('/api/health');ok(h.version==='2.4.0','health version');
  ...
  console.log('FOCO V2.4 tests: PASS');
}catch(e){console.error('FOCO V2.4 tests: FAIL');console.error(e.stack||e);process.exitCode=1}
